...
if ( $tracking_items ) : ?>
	...
	<table class="shop_table shop_table_responsive my_account_tracking">
		<thead>
			<tr>
				<th class="tracking-number"><span class="nobr"><?php _e( 'Tracking Number', 'tmsm-woocommerce-laposte-tracking' ); ?></span></th>
				<th class="date-shipped"><span class="nobr"><?php _e( 'Date', 'tmsm-woocommerce-laposte-tracking' ); ?></span></th>
				<th class="tracking-status"><span class="nobr"><?php _e( 'Status', 'tmsm-woocommerce-laposte-tracking' ); ?></span></th>
